          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className='font-manrope'>
                Set the font used throughout the Workshop shell.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Select the theme preference for Workshop.
              </FormDescription>
              <FormMessage />
              <RadioGroup
                  ...
                  <FormLabel className='[&:has([data-state=checked])>div]:border-primary'>
                    ...
                    <div className='items-center rounded-md border-2 border-muted bg-popover p-1 hover:border-accent'>
                      <div className='space-y-2 rounded-sm bg-background p-2'>
                        <div className='space-y-2 rounded-md border bg-card p-2 shadow-xs'>
                          <div className='h-2 w-20 rounded-lg bg-muted' />
                          <div className='h-2 w-25 rounded-lg bg-muted' />
                        </div>
                        <div className='flex items-center space-x-2 rounded-md border bg-card p-2 shadow-xs'>
